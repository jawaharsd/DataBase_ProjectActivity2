...
public class TaskSpecific extends ListItem {
	...
	//May be error
	static ObservableList <String> effortCategoryList = FXCollections.observableArrayList("None Selected");
static ComboBox <String> chooseUsedEffortCategory = new ComboBox <String>(FXCollections.observableArrayList(effortCategoryList));
	...
	static ComboBox <String> theUsedArtifact = new ComboBox <String>(FXCollections.observableArrayList());
	...
	ObservableList <String> artifactsUsedSelected = FXCollections.observableArrayList();
