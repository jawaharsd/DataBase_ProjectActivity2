...
public class EffortCategorySpecific extends ListItem {
	...
	**********************************************************************************************/
	...
	//may be error
	private static String effortCategoryList[] = { "Artifacts", "Plans", "Interruptions", "Defects", "Other" };
	static ComboBox <String> theChoice = new ComboBox <String>(FXCollections.observableArrayList(effortCategoryList));
	...
	static ComboBox <String> theOption = new ComboBox <String>();
